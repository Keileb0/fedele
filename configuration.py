...
PLUGINS = ["my_new_plugin", "my_new_plugin2", "netbox_qrcode", "netbox_documents"]
...
PLUGINS_CONFIG = {
    ...
    'netbox_qrcode': {
        ...
        'font': 'ArialMT',
        'custom_text': 'Property of SomeCompanytel.8.800333554-CALL',
        'text_location': 'up',
        'qr_version': 1,
...
TIME_ZONE = os.environ.get("TIME_ZONE", "America/Argentina/Cordoba")

# Date/time formatting. See the fol lowing link for supported formats:
